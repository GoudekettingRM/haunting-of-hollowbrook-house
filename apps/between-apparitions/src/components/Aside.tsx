...
const Aside = () => {
  return (
    <aside className='min-w-48 max-w-[30%] lg:min-w-80 sm:ml-12 flex flex-col items-center'>
      ...
      <p className='prose font-minerva text-base/tight mt-4 text-justify'>
        ...
        student. During one of my classes I got introduced to the different beliefs people have. I felt in my bones that
        this was not always merely about belief.
      </p>
    </aside>
  );
};
