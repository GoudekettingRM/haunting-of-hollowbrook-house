...
'use client';
import { useLetterDropTimer } from '@/components/useLetterDropTimer';
...
export default function HomePage() {
  const enabled = useLetterDropTimer(12000);
  return (
      ...
      <div className='pt-4 max-w-screen-lg'>
        ...
        <div className='bg-light-wood bg-opacity-10 p-6 mb-8 text-sm text-dark-wood space-y-2'>
          ...
          <p className='indent-6'>
            ...
            retired schoolteacher with an insatiable curiosity about local history. These meetings, which began as
            simple discussions over tea and biscuits, soon evolved into something more structured as attendees realized
            the importance of documenting and preserving the stories and artifacts of Whispering Hollows.
          </p>
          <p className='indent-6'>
          ...
          <p className='indent-6'>
            Today, our research team, a dedicated group of volunteers and professional historians, continues to delve
            into the mysteries and untold stories of our region. From investigating local legends to uncovering
            forgotten aspects of our industrial heritage, we ensure that our understanding of local history is always
            evolving and deepening. We invite you to explore our archives, attend our events, and join us in preserving
            the rich tapestry of stories that make Whispering Hollows the unique and fascinating place it is today.
          </p>
        </div>
