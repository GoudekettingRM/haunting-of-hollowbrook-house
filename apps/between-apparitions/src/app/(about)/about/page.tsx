const AboutPage = () => {
  return (
    <>
      <div className='font-minerva text-lg/tight text-black text-justify flex flex-col'>
        <h1 className='font-semibold font-sans text-2xl sm:text-3xl lg:text-4xl text-indigo-900 mb-8 mx-auto text-center'>
          About me
        </h1>
        <p className='mb-4'>
        ...
        <p className='mb-4'>
          ...
          Society in 2013. While my paranormal investigations remain a personal pursuit, my work as a curator has given
          me valuable access to historical records and artifacts that help piece together the full story of what
          happened at Hollowbrook House. The intersection of historical fact and unexplained phenomena continues to
          fascinate me.
        </p>
        <p className='mb-4'>
          This blog serves as a record of my investigations and a platform for sharing evidence with fellow researchers.
          While I maintain a skeptical approach, my experiences have taught me that some mysteries defy conventional
          explanation. I believe the truth lies somewhere between blind belief and rigid skepticism.
        </p>
        <p className='mb-4'>
        ...
        <p className='flex flex-col mx-auto text-center'>
          ...
          <span className='block'>James Chen</span>
        </p>
      </div>
    </>
  );
